...
echo ========== Deploy a Kafka cluster - Ref: Lecture 2 Exercise 1 ==========
...
echo ========== Deploy a Kafka Connect, Kafka Schema Registry, and Kafka KSQL - Ref: Lecture 2 Exercise 2 ==========
cd /d %~dp0lectures\03
kubectl apply -f kafka-schema-registry.yaml 
kubectl apply -f kafka-connect.yaml
kubectl apply -f kafka-ksqldb.yaml

echo ========== Deploy Redpanda - Ref: Lecture 2 Exercise 3 ==========
cd /d %~dp0lectures\03
